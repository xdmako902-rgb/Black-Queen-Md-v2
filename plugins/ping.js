...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        const message = await conn.sendMessage(from, { text: '*🍭 𝑷𝒊𝒏𝒈𝒊𝒏𝒈 𝑩𝒍𝒌 𝑸𝒖𝒆𝒆𝒏 𝑴𝒅 𝑽1...*' }, { quoted: mek });
        
        const endTime = Date.now();
        const ping = endTime - startTime;
        
        const pingText = `╭━━━〔 𝑩𝑳𝑨𝑪𝑲 𝑸𝑼𝑬𝑬𝑵 𝑴𝑫 〕━━━┈⊷
┃ 💌 𝑷 𝑰 𝑵 𝑮 !
╰━━━━━━━━━━━━━━━┈⊷
...
*© 𝑩𝑳𝑨𝑪𝑲 𝑸𝑼𝑬𝑬𝑵 𝑴𝑫*`;
        ...
        await conn.sendMessage(from, { 
            image: { url: 'https://res.cloudinary.com/p6lu5bpe/image/upload/v1787195344/l4n5ldfch7jqsldtrsju.jpg' }, 
            caption: pingText 
        }, { quoted: mek });
