            ...
            if (connection === 'close') {
                ...
                if (!global.isBotActiveSent) {
                    try {
                        ...
                        await sock.sendMessage(jid, { image: { url: "https://res.cloudinary.com/p6lu5bpe/image/upload/v1787194509/odg4y9137rhd8bznazyx.jpg" }, caption: activeText });
